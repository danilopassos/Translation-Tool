...
<?php if ($_smarty_tpl->tpl_vars['iarc']->value==$_smarty_tpl->tpl_vars['arc']->value){?>]</b><?php }?></a> </li>
                    <?php } ?>
                </ul>
            </div>
...
<?php if ($_smarty_tpl->tpl_vars['imsbt']->value==$_smarty_tpl->tpl_vars['msbt']->value){?>]</b><?php }?></a> </li>
                    <?php } ?>
                </ul>
            </div>
        </td>
...
<?php if ($_smarty_tpl->tpl_vars['ipos']->value==$_smarty_tpl->tpl_vars['pos']->value){?>]</b><?php }?></a> </li>
                    <?php } ?>
                </ul>
            </div>
        </td>
